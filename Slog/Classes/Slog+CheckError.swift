...
// MARK: - Check functions will check if a condition holds. If the condition is true, the function will return true, if the condition is false the function will return false and log a detailed error.
extension Slog {
